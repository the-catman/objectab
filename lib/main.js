...
exports.OAB_WARN_INT_NOT_SUPP_SET = exports.OAB_WARN_LOOKUP_NOT_FOUND_SET = exports.Writer = exports.Reader = void 0;
;
;
...
class Reader {
    ...
    /** The lookup */
    lookup;
    constructor(content, lookupJSON = []) {
        this.at = 0;
        this.buffer = content;
                        ...
                        for (let i in valKeys) {
                            ...
                            if (tableEnc !== undefined) // If the lookup table found a lookup value,
                            ...
                            else // If it didn't, then put the original property back,
                             {
                                ...
                                this.string(value);
                                if (OAB_WARN_LOOKUP_NOT_FOUND)
                                    console.warn(`Found a key that wasn't in the lookup table! ${value}.`);
                            }
...
function OAB_WARN_LOOKUP_NOT_FOUND_SET(val) {
    OAB_WARN_LOOKUP_NOT_FOUND = val;
}
exports.OAB_WARN_LOOKUP_NOT_FOUND_SET = OAB_WARN_LOOKUP_NOT_FOUND_SET;
function OAB_WARN_INT_NOT_SUPP_SET(val) {
    OAB_WARN_INT_NOT_SUPP = val;
}
exports.OAB_WARN_INT_NOT_SUPP_SET = OAB_WARN_INT_NOT_SUPP_SET;
